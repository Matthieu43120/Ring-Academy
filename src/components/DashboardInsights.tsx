      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            Effectuez au moins 3 simulations pour débloquer l'analyse détaillée de votre progression,
            vos points forts récurrents et vos axes d'amélioration prioritaires.
          </p>
